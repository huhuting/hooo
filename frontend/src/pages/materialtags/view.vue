...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'materialtagsview',
		},
		apiPath: {
			type: String,
			default: 'materialtags/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('edit'),
			command: (event) => { app.openPageDialog({ page:'materialtags/edit', url: `/materialtags/edit/${data.tag_id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = $t('materialTagDetails');
