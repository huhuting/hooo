            ...
            <div class="container-fluid">
                <div class="grid justify-content-center">
                    <div  class="col-12 sm:col-6 md:col-3 comp-grid" >
                        ...
                        <div  class="col-sm-4 col-md-4 col-6 sm:col-6 lg:col-6 md:col-6 comp-grid" >
                            <div class="">
                                <div class="card my-3 p-3 surface-50">
                                    <NotificationLoginapgelistPage ref="notificationListPage"  :limit="10" :show-header="true" :show-breadcrumbs="true" :show-footer="true" :paginate="true" page-store-key="INDEX-NOTIFICATION-LOGINAPGELIST" is-sub-page>
                                    </NotificationLoginapgelistPage>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
	...
	import NotificationLoginapgelistPage from "../notification/loginapgelist.vue";
