                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <div class="mb-3">
                                                        <Uploader :class="getErrorClass('file_path')" :auto="true" :fileLimit="1" :maxFileSize="3000000" accept=".jpg,.png,.gif,.jpeg" :multiple="false" style="width:100%" :label="$t('chooseFilesOrDropFilesHere')" upload-path="fileuploader/upload/file_path" v-model="formData.file_path"></Uploader>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <div class="mb-3">
                                                        <Uploader :class="getErrorClass('video')" :auto="true" :fileLimit="1" :maxFileSize="3000000000" accept=".mp3,.mp4,.webm,.wav,.avi,.mpg,.mpeg" :multiple="false" style="width:100%" :label="$t('chooseFilesOrDropFilesHere')" upload-path="fileuploader/upload/video" v-model="formData.video"></Uploader>
                                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'materialsedit',
		},
		pagePath: {
			type : String,
			default : 'materials/edit',
		},
		apiPath: {
			type: String,
			default: 'materials/edit',
	...
	const formDefaultValues = Object.assign({
		title: "", description: "", file_path: "", category: "", video: "", tag_id: [], 
	}, props.pageData);
