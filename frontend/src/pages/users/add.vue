                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlis_teacher" v-model.trim="formData.is_teacher"  :label="$t('isTeacher')" type="number" :placeholder="$t('enterIsTeacher')"   step="any"    
                                                    class=" w-full" :class="getErrorClass('is_teacher')">
                                                    </InputText>
                                                    <small v-if="isFieldValid('is_teacher')" class="p-error">{{ getFieldError('is_teacher') }}</small> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		pageData: { // use to set formData default values from another page
			type: Object,
			default: () => ({
				username: "", email: "", password: "", confirm_password: "", usertele: "", photo: "", created_at: "CURRENT_TIMESTAMP", updated_at: "CURRENT_TIMESTAMP", is_teacher: "0", 
			})
		},
	});
	//lines
