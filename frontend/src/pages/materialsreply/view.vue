                        ...
                        <div class="grid justify-content-between align-items-center">
                            ...
                            <div  class="col " >
                                <div class=" text-2xl text-primary font-bold" >
                                    {{ $t('materialsReplyDetails') }}
                                </div>
                            </div>
                            <div  class="col-sm-4 col-md-4 col-6 comp-grid" >
                                <Button :label="$t('reply')" icon="pi pi-file-edit"  @click="app.openPageDialog({ page: 'replyreply/add', url: `/replyreply/add` , closeBtn: true })"  class="p-button w-full bg-pink-300 "  />
                            </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3 grid ">
                                            ...
                                            <div class="col-12 md:col-4">
                                                <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                                    <div class="">
                                                        <div class="text-400 mb-1">{{ $t('replayContent') }}</div>
                                                        <div class="font-bold">{{ item.replay_content }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 md:col-4">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'materialsreplyview',
		},
		apiPath: {
			type: String,
			default: 'materialsreply/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('edit'),
			command: (event) => { app.openPageDialog({ page:'materialsreply/edit', url: `/materialsreply/edit/${data.reply_id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = $t('materialsReplyDetails');
